...
class GraphCtrl extends MetricsPanelCtrl {
  ...
  initEditMode() {
    ...
    this.addEditorTab('Axes & Grid', 'public/app/plugins/panel/histogram/axisEditor.html', 2);
    this.addEditorTab('Display Styles', 'public/app/plugins/panel/histogram/styleEditor.html', 3);
